        ...
        <div class="info-group">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <code style="background: rgba(var(--primary-rgb), 0.1); color: var(--primary); padding: 4px 10px; border-radius: 6px; font-size: 12px; cursor: pointer;" onclick="copyToClipboard('<?php echo SITE_URL . '/' . $company['slug']; ?>', 'Slug copiada!')" title="Clique para copiar"><?php echo htmlspecialchars($company['slug']); ?> <i data-lucide="copy" class="icon-lucide"></i></code>
                </div>
